...
function mln_CalEvaN_priordata(dirname,prenom,strfile,paramsfile,nc,is,npts,cs,models)
...
MULANCalMUltiBP_priordata(dirname,dataname,paramsfile,VGroupMethlog)
